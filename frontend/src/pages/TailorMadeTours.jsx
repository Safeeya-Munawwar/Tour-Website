      ...
      <div className=" flex flex-col min-h-screen font-poppins bg-white text-[#222]">
        ...
        <section className="max-w-7xl mx-auto px-5 md:px-20 py-10 grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 px-4 md:px-12 py-10 md:py-20">
            ...
            <p className="text-gray-500 text-center text-base md:text-lg">
              We are here to support you 24 hours a day. If you’re travelling
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          ...
          <p className="text-sm sm:text-base text-center text-gray-600 leading-relaxed">
            Our tailor-made tours are thoughtfully designed around your comfort,
            interests, and pace, ensuring every moment of your Sri Lanka journey
            is enjoyable. From exploring hidden gems to visiting iconic
            landmarks, each itinerary is personalized to match your travel
            style. We take care of all the details, from comfortable transport
            to carefully selected accommodations, so you can focus on creating
            memories. Whether you prefer sightseeing, adventure, or relaxation,
            your tour flows seamlessly at your own pace. Our goal is to make
            your holiday effortless, stress-free, and truly unforgettable.
            Experience Sri Lanka the way you’ve always imagined, with every
            detail crafted just for you.
          </p>
