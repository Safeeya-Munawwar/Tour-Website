  ...
  return (
    <section className="font-poppins bg-white text-[#222] mb-10">
      ...
      >
        ...
        <div
          className={`absolute bottom-10 right-10 w-[300px] bg-black/80 text-white p-6 backdrop-blur-sm shadow-lg border-none flex items-center justify-end transition-all duration-700 ease-out ${
