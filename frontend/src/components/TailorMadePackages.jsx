...
const packages = [
  ...
  },
  {
    ...
    includes: [
      ...
      {
        icon: <FaUserTie />,
        text: "Chauffeur Guide Driver (Request Language)",
      },
      { icon: <FaUsers />, text: "Private Guide (Optional)" },
      { icon: <FaMapMarkedAlt />, text: "Fully Customized Itinerary" },
  ...
  },
  {
    ...
    includes: [
      ...
      {
        icon: <FaUserTie />,
        text: "Chauffeur Guide Driver (English speaking)",
      },
      {
        icon: <MdChildCare />,
        text: "Transportation Free for Kids (Under 14)",
      ...
      {
        icon: <FaTicketAlt />,
        text: "Entrance Fees Not Included",
      },
      { icon: <FaPlaneArrival />, text: "Airport Pick-up & Drop" },
    ],
  },
...
>
      ...
      <button className="mt-5 w-full rounded-xl bg-black text-white py-2 hover:opacity-90 transition">
  Enquire Now
</button>
