...
export default function DestinationForm({ formData, setFormData, handleSubmit, submitLabel }) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        {/* Subtitle */}
        <div>
          <label className="block font-semibold mb-1 text-[#2E5B84]">Subtitle</label>
          <input
            type="text"
        ...
        {/* Title */}
        <div>
          <label className="block font-semibold mb-1 text-[#2E5B84]">Title</label>
          <input
            type="text"
        ...
        {/* Image */}
        <div>
          <label className="block font-semibold mb-2 text-[#2E5B84]">Destination Image</label>
          <div
            {...getRootProps()}
